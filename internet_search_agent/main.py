    ...
    while True:
        ...
        if analysis_match:
            ...
            try:
                ...
                analysis_result = final_state.get("synthesis_result") or final_state.get("error_message", "Graph finished, but no result/error found in state.")
                print("\nAnalysis Result:")
                print(analysis_result)

            except Exception as e:
                logging.error(f"Error invoking analysis graph for '{industry_name}': {e}", exc_info=True)
